...
\urlstyle{same}
\hypersetup{
  pdftitle={Using Papaja for ICMA Nov 11},
...
\title{Using Papaja for ICMA Nov 11}
\author{Maanav Choudhary\textsuperscript{1}}
\date{}


\shorttitle{ICMA Nov 11}
...
Correspondence concerning this article should be addressed to Maanav Choudhary, Private. E-mail: \href{mailto:maanavpilania63@gmail.com}{\nolinkurl{maanavpilania63@gmail.com}}
...
There is a significant diff in the avg weight of chicks who received Diet 1 compared to Diet 3, \(\Delta M = -40.30\), 95\% CI \([-57.62, -22.99]\), \(t(175.92) = -4.59\), \(p < .001\)



\begin{figure}
\centering
\includegraphics{ICMANov11_files/figure-latex/chick-plot-1.pdf}
\caption{\label{fig:chick-plot}Each chick was weighed every other day from birth to day 20 and on day 21. This plot shows the weight of each chick (y-axis) for each day they were measured(x-asix)}
\end{figure}

\begin{figure}
\centering
\includegraphics{ICMANov11_files/figure-latex/red-plot-1.pdf}
\caption{\label{fig:red-plot}red plot}
\end{figure}
